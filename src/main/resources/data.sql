...
insert into seller (id, last_name, first_name, email) values (seller_seq_id.nextval, 'Redford', 'Robert', 'bob@gmail.com');

insert into offer (id, date, postal_code, car_brand, car_model, year, gearbox, outer_color, four_wheel_drive, description, price, seller_id)
